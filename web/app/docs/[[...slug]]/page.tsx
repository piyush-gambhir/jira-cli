  ...
  return (
    <>
      ...
      <DocsPage
        toc={page.data.toc}
        full={page.data.full}
        className="jira-docs-page"
      >
        <DocsTitle className="jira-docs-title">{page.data.title}</DocsTitle>
        <DocsDescription className="jira-docs-description mb-0">
          {page.data.description}
        </DocsDescription>
        <div className="jira-docs-actions flex flex-row gap-2 items-center pb-6">
        ...
        <DocsBody className="jira-docs-body">
          <MDX
